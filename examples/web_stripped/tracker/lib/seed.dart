...
var data = [
    new Task(
        'Create a skeletal polymer app',
        'This should just be a simple coat-hanger. ' 'Just enough to get started.',
        Task.COMPLETED),
    new Task(
        'Create a seeds file',
    ...
    new Task(
        ...
        'Right now, only the title is displayed. Let users '
            'click on a link to toggle between full display and title-only ' 'display.',
        Task.CURRENT),
    new Task(
        'On-focus and on-blur do not work',
