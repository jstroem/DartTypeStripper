...
const FIELDS = const ['name', 'description', 'size', 'watchers', 'forks'];

var table = querySelector('#repo-table');
...
main() {
  ...
  script.src =
      "https://api.github.com/users/dart-lang/repos?callback=processData";
