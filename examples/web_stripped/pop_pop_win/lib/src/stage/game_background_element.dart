...
class GameBackgroundElement extends Sprite {
  ...
  get _backgroundScale => (parent as GameElement).boardScale;
  get _boardSize => (parent as GameElement).boardSize;
  get _game => (parent as GameElement).game;

  GameBackgroundElement(gameElement, op) {
    addTo(gameElement);
