...
class SquareElement extends Sprite {
  ...
  static const _balloonBits = const [
      'balloon_pieces_a',
      'balloon_pieces_b',
      'balloon_pieces_c',
      'balloon_pieces_d'];

  static const _numberMap = const [
      "game_board_center",
      "number_one",
      "number_two",
      "number_three",
  ...
  get squareState => _game.getSquareState(x, y);

  get _adjacentCount => _game.field.getAdjacentCount(x, y);
  ...
  get _gameElement => _board.gameElement;

  get _opaqueAtlas => _board.opaqueAtlas;

  get _game => _board.game;
}
