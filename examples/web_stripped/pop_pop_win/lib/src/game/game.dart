...
class Game {
  final field;
  final _states;
  final _updatedEvent = new StreamController();
  final _gameStateEvent = new StreamController<GameState>();
  ...
  get bombsLeft => _bombsLeft;

  get revealsLeft => _revealsLeft;

  get state => _state;

  get updated => _updatedEvent.stream;

  get stateChanged => _gameStateEvent.stream;

  getSquareState(x, y) => _states.get(x, y);

  get gameEnded => _state == GameState.won || _state == GameState.lost;
  ...
  _update() => _updatedEvent.add(null);
